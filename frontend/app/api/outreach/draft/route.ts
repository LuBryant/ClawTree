...
export async function POST(request: NextRequest) {
  ...
  return NextResponse.json({
    ...
    body: `${target.organization}的老师/同学，您好：\n\n我们是大树财经。结合 7 月广州高校行与全球足球赛事的公共讨论，我们计划发起一场“全球足球赛事 × AI：事件驱动市场与数据权益”校园内容单元。\n\n贵组织与本次主题的匹配点是：${target.reasons.slice(0, 2).join('；')}。基于公开能力证据，我们建议先从「${target.recommendedFormat}」开始共创。\n\n如有兴趣，我们可以先用 30 分钟对齐受众、嘉宾和时间。本活动只做财经素养与技术教育：不涉及博彩，不预测比分，不构成投资建议，不承诺收益或结果。\n\n大树财经高校行团队（演示草稿，请勿直接发送）`,
